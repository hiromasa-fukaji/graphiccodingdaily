class DesignSystem {
  ...
  setupPane() {
    ...
    this.fontSizeInput = this.pane.addInput(this.selectedParams, 'fontSize', { min: 10, max: 200, step: 1 });
    ...
    for (const el of targets) {
      ...
      const context = {
        ...
        elementChanged: () => {
          ...
          return !el._state._lastVersion || el._state._lastVersion !== el.version;
        },
